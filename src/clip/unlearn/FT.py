...
def FT(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args, tb_writer=None, mask=None, tokenizer=None, preprocess=None, celeb_name=None, date_str=''):
