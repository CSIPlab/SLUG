...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to file(s) with forget data",
    )
    parser.add_argument(
        "--train-num-samples",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Only unlearn the visual or language part",
    )
    parser.add_argument(
        "--unlearn-layer",
        type=str,
        default=None,
        help="Only unlearn this layer",
    )
    parser.add_argument(
        "--celeb-name",
        type=str,
        default="Elon_Musk",
        help="name to unlearn."
    )
    parser.add_argument(
        "--clip-model-id",
        type=str,
        default="laion/CLIP-ViT-H-14-laion2B-s32B-b79K",
        help="clip model repo"
    )
    # parser.add_argument("--celeb_name",type=str, default='Elon_Musk', help="celeb name") 
    # parser.add_argument("--pair",type=str, default="ViT-B-32 laion400m_e32", help="model name and ckpt")
    ...
    parser.add_argument("--layer_name",type=str, default='visual.proj', help="layer name, for linear") 
    parser.add_argument("--r_lo_limit",type=float, default=-1, help="r_lo_limit")
    parser.add_argument("--update_whole_model", action='store_true', help="update whole model")
