...
- ImageNet 2012. We use the imagenet validation set to evaluate CLIP model general performance. Request access here https://www.image-net.org/download.php Download and unzip `ILSVRC2012 2012 Val` Run `data/ImageNet/valprep.sh` to prepare dataset.
